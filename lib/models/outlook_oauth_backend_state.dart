class OutlookOAuthBackendState {
  final String userId;
  ...
  const OutlookOAuthBackendState({
  ...
  OutlookOAuthBackendState copyWith({
    String? userId,
    String? accountId,
    String? provider,
    String? accountEmail,
    ...
    return OutlookOAuthBackendState(
  ...
  factory OutlookOAuthBackendState.fromMap(Map<String, dynamic> map) {
    return OutlookOAuthBackendState(
      userId: map['user_id'] as String? ?? '',
      accountId: map['account_id'] as String? ?? '',
      provider: map['provider'] as String? ?? 'outlook',
